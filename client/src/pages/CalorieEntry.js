...
class CalorieEntry extends React.Component {
    ...
    validateFormData = () => {
        ...
        // The following else statement is creating a data object and empties the error-message field once it passes all validation
            ...
            // } 
            //   if (ingredientNameCaloriesPerGram.trim()!="" && ingredientNameCaloriesPerGram.trim()!=0){
            //     var sectionNumber = "C";
    ...
    render() {
        ...
        <div>
            ...
            <div className="pageWrapper">
                ...
                {/* Page header */}
                <div className="pageHeader">Data Entry</div>
                            ...
                            <Col size="col-md-6 offset-md-3">           
                                ...
                                <Row>
                                    ...
                                    <Col size="col-md-10">
                                        ...
                                        <p className="mainContentTextBlack">Please enter one or more of the following parts:</p>
                                ...
                                <Row>
                                    ...
                                    <Col size="col-md-10">
                                        <p className="mainContentTextBlack">Pee description:</p>
                                        ...
                                        {/* </select> */}
                                        {/* <Br /> */}
                                        <input type="text" className="form-control" id="calorieEntryPage-mealQuantity" placeholder="Color" autoComplete="off"></input>  
                                ...
                                <Row>
                                    ...
                                    <Col size="col-md-10">
                                        <p className="mainContentTextBlack">Poop description:</p>
                                        ...
                                        {/* </select> */}
                                        {/* <Br /> */}
                                        <input type="text" className="form-control" id="calorieEntryPage-drinkQuantity" placeholder="Color" autoComplete="off"></input>   
                                        {/* In the above line, set input type to be "number" instead of "text". This will force the user
                                            to only be able to enter numbers into the input field on the front end. Note, that the numbers
                                            will still capture as a string, so this string still has to be parseFloat on the backend */}
                                        {/* autoComplete="off" is used to turn off the autoComplete of input field */}
                                ...
                                <Row>
                                    ...
                                    <Col size="col-md-10">
                                        <p className="mainContentTextBlack">Nursed breast:</p>
                                        ...
                                        <Br />
                                        <input type="text" className="form-control" id="calorieEntryPage-ingredientGrams" placeholder="Duration" autoComplete="off"></input>    
                                        {/* In the above line, set input type to be "number" instead of "text". This will force the user
                                            to only be able to enter numbers into the input field on the front end. Note, that the numbers
                                            will still capture as a string, so this string still has to be parseFloat on the backend */}
                                        {/* autoComplete="off" is used to turn off the autoComplete of input field */}
                                ...
                                <Row>
                                    ...
                                    <Col size="col-md-10">
                                        <p className="mainContentTextBlack">Baby Formula:</p>
                                ...
                                <Row>
                                    ...
                                    <Col size="col-md-10">
                                        ...
                                        {/* autoComplete="off" is used to turn off the autoComplete of input field */}
                                        {/* <Br /> */}
                                        <input type="text" className="form-control" id="calorieEntryPage-manualEntryCalories" placeholder="Amount" autoComplete="off"></input>     
                                        {/* In the above line, set input type to be "number" instead of "text". This will force the user
                                            to only be able to enter numbers into the input field on the front end. Note, that the numbers
                                            will still capture as a string, so this string still has to be parseFloat on the backend */}
                                        {/* autoComplete="off" is used to turn off the autoComplete of input field */}
